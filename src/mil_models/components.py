...
def SNN_Residual_Block(dim, dropout=0.25):
    """
    Residual Block for SNN with input and output of the same dimension.
    """
    import torch.nn as nn
    ...
    return Residual(dim, dropout)

def SNN_Residual_Block_2(dim, dropout=0.25):
...
def SNN_Residual_Block_3(dim, dropout=0.25):
